        ...
        <div class="bg-white p-4 rounded-xl shadow-sm border border-slate-200">
            <form method="GET" class="flex gap-3 max-w-md">
                <div class="relative flex-1">
                    <input type="text" name="search" value="<?= htmlspecialchars($search) ?>" placeholder="Search course title..." class="w-full pl-9 pr-3 py-2 text-xs border border-slate-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:outline-none">
                            ...
                            <tr class="hover:bg-slate-50/80 transition">
                                ...
                                <td class="px-6 py-4 text-right">
                                    <div class="inline-flex items-center space-x-2">
                                        ...
                                        <a href="delete.php?id=<?= $c['id'] ?>" onclick="return confirm('Delete course: <?= addslashes($c['name']) ?>?')" class="p-1.5 bg-rose-50 hover:bg-rose-100 text-rose-600 rounded transition" title="Delete Course">
